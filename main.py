...
with tab_briefing:
    st.header("Gerador de Briefing Broto_Tecnologia")
    st.caption("Crie briefings completos para diferentes áreas de atuação da Broto_Tecnologia")
    ...
    with tab_new:
        ...
        def criar_campo_selecionavel(rotulo, tipo="text_area", opcoes=None, padrao=None, key_suffix=""):
            ...
            if auto_preencher:
                ...
                prompt = f"Com base no seguinte contexto:\n{contexto}\n\n E o objetivo do briefing {objetivo_geral} \n\nPreencha o campo '{rotulo}' para um briefing do tipo {tipo_briefing} no Broto_Tecnologia. Retorne APENAS o valor para o campo, sem comentários ou formatação adicional."
    ...
    with tab_saved:
        ...
        collection_briefings = client2.briefings_Broto_Tecnologia.briefings  # Ajuste aqui
...
with tab_resumo:
    ...
    st.caption("Resuma textos longos mantendo o alinhamento com as diretrizes da Broto_Tecnologia")
            ...
            if not texto_original.strip():
                ...
                with st.spinner("Processando resumo..."):
                    try:
                        ...
                        prompt = f"""
                        Crie um resumo profissional deste texto para a Broto_Tecnologia Cooperativa Agroindustrial,
                        ...
                        - Mantenha o tom profissional da Broto_Tecnologia
                        ...
                        st.download_button(
                            "📋 Copiar Resumo",
                            data=resposta.text,
                            file_name="resumo_Broto_Tecnologia.txt",
                            mime="text/plain"
                        )
    ...
    with tab_briefing_gerados:
        st.header("📚 Briefings Gerados - Broto")
        st.markdown("---")
